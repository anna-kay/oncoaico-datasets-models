    ...
    def __init__(self, image_root, gt_root, trainsize, augmentations):
        ...
        if self.augmentations == True:
            ...
            self.img_transform = transforms.Compose([
                transforms.RandomRotation(90, interpolation=InterpolationMode.NEAREST, expand=False, center=None), # transforms.RandomRotation(90, resample=False, expand=False, center=None),
